...
/* for testing I've reduced POP_SIZE from 100 to 10 */
/* and MAX_GEN from 10000 to 100 */
...
int main(){
    ...
    while( (gen < MAX_GEN) && (best_ifit > EPSILON)) {
        ...
        for(i=0; i < POP_SIZE; i++){
            ...
            /* this shows how best_fit gets better and better as more iterations are made */
            printf("x= %f  =>  y=  %+f     ifit = %f best_ifit=%+f\n", x, y, ifit, best_ifit);
