...
class Scrape:
    ...
    def scrape(self):
      ...
      ucas_codes = []
      #ucas_codes = ['H401']
      #ucas_codes = ['H401', 'H402', 'H403']
      ucas_codes = ['H400', 'H401', 'H402', 'H490', 'H491', 'H493', '09F4', 'HW73', 'H422', 'H4H1', 'HH41']
      ...
      try:
                ...
                if not ucas_codes or ucas_code in ucas_codes:
                  ...
                  if saved_record is not None:
                    ...
                    if saved_availability != availability:
                      ...
                      email_message = str(change_message) + "\n\n" + str(url)
                                
                      self.send_mails(change_message, email_message)
        ...
        self.log("Connection error: {0}".format(err))
        self.log("Connection error:", sys.exc_info()[0])
      except:
    ...
    def send_mails(self, subject, body):
        mailing_list = ['mike@stollery.uk', 'lily@stollery.co.uk', 'sandra@stollery.co.uk']
